    ...
    const callsChannel = supabase
      ...
      .on(
        ...
        (payload: any) => {
          ...
          } else if (payload.new.status === 'completed' || payload.new.status === 'no-answer') {
            setActiveCall(null)
            setIncomingCall(null)
          }
        }
